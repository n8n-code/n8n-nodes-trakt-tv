...
export class TraktTvApi implements ICredentialType {
	name = 'N8nDevTraktTvApi';

	displayName = 'trakt-tv API';

	icon: Icon = { light: 'file:../nodes/TraktTv/trakt-tv.png', dark: 'file:../nodes/TraktTv/trakt-tv.dark.png' };
	...
	properties: INodeProperties[] = [
		{
			...
			description: 'The base URL of your trakt-tv API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
